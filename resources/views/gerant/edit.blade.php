    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="gerant-hotel-edit.html" class="navbar-brand d-flex d-lg-none me-4">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        <h5 style="color: var(--text-primary); font-weight: 700;">Edit Hotel: Le Luxury Plaza</h5>
                    </div>
                </div>
            </div>
            <!-- Page Header End -->

            <!-- Warning Alert (for pending/rejected hotels) -->
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        <div class="alert alert-warning border-0 rounded-3" style="background: #FFF3E0; color: #E67E22; border-left: 4px solid #F39C12;">
                            <i class="fa fa-exclamation-triangle me-2"></i>
                            <strong>Important:</strong> This hotel is currently pending review. Modifications will require a new approval process.
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div style="padding: 2rem;">
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="hotelName" placeholder="Enter your hotel name" value="Le Luxury Plaza" required>
                                    </div>

                                    <!-- Address -->
                                    <div class="mb-3">
                                        <label for="address" class="form-label" style="color: var(--text-primary); font-weight: 600;">Address *</label>
                                        <input type="text" class="form-control" id="address" placeholder="Street address" value="42 Rue de Rivoli, Paris" required>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="city" placeholder="City" value="Paris" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="postal" class="form-label" style="color: var(--text-primary); font-weight: 600;">Postal Code</label>
                                            <input type="text" class="form-control" id="postal" placeholder="Postal code" value="75001">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="description" rows="4" required>Experience luxury and elegance at Le Luxury Plaza, our premier 5-star hotel in the heart of Paris. Located near iconic landmarks, we offer world-class amenities and exceptional service.</textarea>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <label class="input-group-text" for="images">Update files</label>
                                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="table-container">
                            <div style="padding: 1.5rem;">
                                <h6 style="color: var(--text-primary); font-weight: 700; margin-bottom: 1rem;">Hotel Status</h6>
