                        ...
                        <div class="table-container p-4">
                            ...
                            <form action="{{ route('gerant.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="addresse" class="form-control" value="addresse" required>
                                </div>
                                ...
                                <div class="mb-4">
                                   ...
                                   <input type="file" name="images[]" multiple enc>
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('gerant.index') }}" class="btn btn-light border">
                                        Cancel
                                    </a>
                                </div>
