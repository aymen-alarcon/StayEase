...
<head>
    <meta charset="utf-8">
    <title>Gérant Dashboard - Hotel Manager</title>
    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="gerant.html" class="navbar-brand mx-4 mb-3">
                ...
                <div class="navbar-nav w-100">
                    <a href="gerant.html" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="gerant-dashboard.html" class="navbar-brand d-flex d-lg-none me-4">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Your hotel was approved</h6>
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Admin sent feedback</h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="kpi-card">
                            <div class="p-4">
                                ...
                                <h6 class="kpi-value" style="color: var(--warning);">2</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="kpi-card">
                            <div class="p-4">
                                ...
                                <h6 class="kpi-value" style="color: var(--success);">5</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="kpi-card">
                            <div class="p-4">
                                <i class="fa fa-times-circle fa-3x kpi-icon danger-red"></i>
                                <p class="kpi-label">Rejected</p>
                                <h6 class="kpi-value" style="color: var(--danger);">1</h6>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-container">
                            <div style="padding: 1.5rem;">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <h6 class="mb-0">My Recent Hotels</h6>
                                    <a href="gerant-hotels.html" class="btn btn-primary btn-sm">View All</a>
                                </div>
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="gerant-hotel-show.html" class="btn btn-sm btn-review">View</a></td>
                                            </tr>
                                            <tr>
